S3Bucket = "beta.bountyforcode.com"
...
task :deploy_bounty do
   Dir.chdir "bounty" do
    system "go build"
  end
end

task :deploy_ghwatch do
  Dir.chdir "ghwatch" do
    system "go build"
  end
end

task :deploy => [:deploy_bounty, :deploy_ghwatch, :deploy_frontend] do
